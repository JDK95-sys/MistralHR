...
const POLICY_SECTIONS: Record<string, { heading: string; content: string }[]> = {
    Leave: [
        { heading: "1. Purpose & Scope", content: "This policy defines the annual, parental, and special leave entitlements for all Worldline employees. It applies to permanent and fixed-term contract holders across all applicable jurisdictions." },
        { heading: "2. Entitlements", content: "Standard annual leave is a minimum of 20 working days per year, with additional Worldline-granted days varying by country (up to 6 extra days in Belgium, 3 RTT days in France, 10 days in Germany). Part-time employees receive entitlements on a pro-rata basis." },
    ...
    "Remote Work": [
        { heading: "1. Purpose & Scope", content: "This policy establishes the framework for remote and hybrid working arrangements at Worldline. It applies to all roles where remote work is operationally feasible, subject to local regulations." },
        ...
        { heading: "4. Equipment & Expenses", content: "Worldline provides a €500 home office setup allowance for new remote workers. Monthly internet reimbursement of €40 is available. All equipment remains Worldline property and must be returned upon departure." },
        { heading: "5. Health & Safety", content: "Employees must ensure their remote workspace meets basic ergonomic standards. A self-assessment checklist must be completed annually. Worldline maintains employer liability for work-related injuries sustained during remote work hours." },
    ],
    Expenses: [
        { heading: "1. Purpose & Scope", content: "This policy governs the reimbursement of business expenses incurred by Worldline employees. All expenses must be reasonable, necessary, and directly related to Worldline business activities." },
        ...
        { heading: "4. Per Diem & Meal Allowances", content: "Daily meal allowances vary by country: €20 (Belgium), €25 (France), €24 (Germany), €20 (Netherlands). International travel per diem rates follow the Worldline rate card, updated quarterly." },
    ...
    "Health & Benefits": [
        { heading: "1. Purpose & Scope", content: "This policy outlines the health, medical, and supplementary benefits provided to Worldline employees. Coverage varies by country and employment type." },
        { heading: "2. Group Insurance", content: "All permanent employees are enrolled in Worldline's group hospitalisation insurance from day one. Coverage extends to dependants (spouse/partner and children under 25). Pre-existing conditions are covered after a 12-month waiting period." },
        ...
        { heading: "5. Wellness Programs", content: "Worldline offers annual health screenings, flu vaccinations, ergonomic assessments, and access to a 24/7 employee assistance programme. Mental health first aiders are available in each major office." },
    ],
    "Code of Conduct": [
        { heading: "1. Ethical Standards", content: "All Worldline employees are expected to act with integrity, transparency, and respect. This includes honest communication, fair dealing with customers and partners, and compliance with all applicable laws and regulations." },
        { heading: "2. Anti-Corruption", content: "Worldline has zero tolerance for bribery and corruption. Gifts exceeding €50 must be declared. Government official interactions require pre-approval from Legal. Third-party due diligence is mandatory for new business partners." },
        ...
        { heading: "4. Whistleblowing", content: "Worldline provides a confidential reporting channel (EthicsLine) for reporting suspected misconduct. Reports can be made anonymously. Retaliation against whistleblowers is strictly prohibited and subject to disciplinary action." },
    ...
    "Data & Privacy": [
        { heading: "1. Purpose & Scope", content: "This policy describes how Worldline collects, processes, and protects employee personal data in compliance with the General Data Protection Regulation (GDPR) and applicable local laws." },
        { heading: "2. Data Collection", content: "Worldline collects personal data necessary for employment administration, payroll, benefits management, and legal compliance. Special category data (health, trade union membership) is processed only where legally required." },
    ...
    Learning: [
        { heading: "1. Purpose & Scope", content: "This framework establishes Worldline's commitment to continuous learning and professional development for all employees. It outlines available resources, budget allocations, and the annual learning cycle." },
        ...
        { heading: "4. Certification Support", content: "Worldline reimburses exam fees for pre-approved professional certifications. Study leave of up to 5 days per year is available for exam preparation. Successful certification results in a one-time bonus of €500." },
...
function PolicyContent({ topic, countries, title }: { topic: string; countries: string[]; title: string }) {
    const sections = POLICY_SECTIONS[topic] ?? [
        { heading: "1. Purpose & Scope", content: `This policy outlines the guidelines for ${title.toLowerCase()} at Worldline. It applies to all employees in: ${countries.join(", ")}.` },
